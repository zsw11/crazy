...
public class BallService {
	...
	public BallService(BallFrame frame, int width, int height)
		...
		// 创建一个Stick(档板)实例
		stick = new Stick(width, height, "E:\\git项目\\project_codes\\ball\\img\\stick.jpg");
		// 创建一个弹球的实例
		ball = new Ball(width, height, stick.getImage().getHeight(null),
				"E:\\git项目\\project_codes\\ball\\img\\ball.gif");
		// 游戏结束图片
		gameOver = new BallComponent("E:\\git项目\\project_codes\\ball\\img\\over.gif");
		// 赢图片
		won = new BallComponent("E:\\git项目\\project_codes\\ball\\img\\win.gif");
		// 砖块图片数组
		bricks = createBrickArr("E:\\git项目\\project_codes\\ball\\img\\brick.gif", 11, 6);
	}
